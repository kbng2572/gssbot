...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install gssbot-ai[matrix]"
    ) from e

from gssbot.bus.events import OutboundMessage
from gssbot.channels.base import BaseChannel
from gssbot.config.paths import get_data_dir, get_media_dir
from gssbot.utils.helpers import safe_filename
