...
from gssbot.config.paths import get_media_dir
from gssbot.config.schema import TelegramConfig
from gssbot.utils.helpers import split_message
...
class TelegramChannel(BaseChannel):
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm gssbot.\n\n"
        ...
        if media_file and self._app:
            try:
                ...
                if media_type == "voice" or media_type == "audio":
                    from gssbot.providers.transcription import GroqTranscriptionProvider
