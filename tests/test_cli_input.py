...
from gssbot.cli import commands
...
def mock_prompt_session():
    ...
    with patch("gssbot.cli.commands._PROMPT_SESSION", mock_session), \
         patch("gssbot.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("gssbot.cli.commands.PromptSession") as MockSession, \
         patch("gssbot.cli.commands.FileHistory") as MockHistory, \
